...
public class CustomIndexPriorityQueue<T extends Comparable<T>> {
    ...
    public CustomIndexPriorityQueue(int initCapacity) {
        if (initCapacity <= 0) {
    ...
    public CustomIndexPriorityQueue(int initCapacity, boolean isMax) {
        this(initCapacity);
        this.isMax = isMax;
    }
